...
public class SahneeBotConsoleFormatter : ConsoleFormatter, IDisposable
{
    ...
    public SahneeBotConsoleFormatter(IOptionsMonitor<SimpleConsoleFormatterOptions> options
        , ConsoleLoggingController loggingController)
    ...
    public static void WriteColoredMessage(TextWriter textWriter, string message, ConsoleColor? background,
        ...
        IExternalScopeProvider scopeProvider)
    {
        ...
        textWriter.Write("Ich hab Alice ganz dolle lieb <3 ");
