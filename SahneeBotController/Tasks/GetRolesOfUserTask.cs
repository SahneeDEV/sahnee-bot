...
/// </summary>
public abstract class GetRolesOfUserTask: ITask<GetRolesOfUserTask.Args, IEnumerable<RoleTypes>>
{
    /// <summary>
    ...
    public abstract Task<IEnumerable<RoleTypes>> Execute(ITaskContext ctx, Args arg);
